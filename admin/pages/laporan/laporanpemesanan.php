...
$bulan=$_GET['bulan'];
$tahun=$_GET['tahun'];
$data=$laporan->laporanpemesanan($bulan,$tahun);
...
<center>
<h5>
<strong><u>Laporan Penjualan Pemesanan</u></strong><br><br>	
</h5>
</center>
</td>
<td></td>
...
<td >
	<?php if (empty($data)): ?>
		<div class="alert alert-danger">
			<p>Belum ada pemesanan pada bulan <?php echo $bulan; ?> dan Tahun <?php echo $tahun; ?></p>
		</div>
	<?php else: ?>
...
<?php foreach ($data as $key => $value): ?>
	<?php  
	$tot_b += $value['subharga'];
	$hrg_mk = $value['harga_modalkatalog'];
